...
module.exports = class MentionManager extends Plugin {
  async startPlugin() {
    ...
    const buttonTemplate = document.querySelector(".buttons-3JBrkn > div:nth-child(2)").cloneNode(true)
    buttonTemplate.id = "mentions-toggle"
    buttonTemplate.firstChild.ariaLabel = "Toggle mentions"
    buttonTemplate.firstChild.firstChild.firstChild.innerHTML = mentionIcon
    buttonTemplate.addEventListener("click", console.log)
    
    document.querySelector(".buttons-3JBrkn").appendChild(buttonTemplate)
  }
};
